...
def main():
    ...
    rootname="!notebook"
    if 'TRAINING' in yamldict.keys():
        wid_cnn_lbfr = root.nametowidget(rootname+'.training.cnn')
        wid_cnnstruc_lbfr = root.nametowidget(rootname+'.training.cnn.structure')
        wid_cnnimgtr_lbfr = root.nametowidget(rootname+'.training.cnn.image_training')
        wid_cnnepetr_lbfr = root.nametowidget(rootname+'.training.cnn.epe_training')
        wid_cnnimgtr_lbfr.grid_forget()
        wid_cnnepetr_lbfr.grid_forget()
        wid_cnnstruc_lbfr.grid_forget()
        root.nametowidget(rootname+'.training.cnn._skip_inputs_label').grid_forget()    
        root.nametowidget(rootname+'.training.cnn._skip_inputs').grid_forget()
